    ...
    public partial class ItemHomepage : UserControl
    {
        ...
        private void dgvItem_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            try
            {
                ...
                string Query = string.Format("(select P.TableName,P.PartyName,C.SalePrice,C.Qty,C.freeQty,P.Status,P.Company_ID,P.DeleteData from tbl_CreditNote1 as P, tbl_CreditNoteInner as C  where P.ID=C.ID and ItemName='{0}' and P.Company_ID='" + NewCompany.company_id + "' and P.DeleteData='1')union all(select P.TableName, P.PartyName, C.SalePrice, C.Qty, C.freeQty, P.Status,P.Company_ID,P.DeleteData from tbl_DebitNote as P , tbl_DebitNoteInner as C   where P.ID = C.ID and ItemName = '{0}' and P.Company_ID='" + NewCompany.company_id + "' and P.DeleteData='1')Union all(select P.TableName, P.PartyName, C.SalePrice, C.Qty, C.freeQty, P.Status,P.Company_ID,P.DeleteData from tbl_DeliveryChallan as P , tbl_DeliveryChallanInner as C    where P.ID = C.ID and ItemName = '{0}' and P.Company_ID='" + NewCompany.company_id + "' and P.DeleteData='1')union all(select P.TableName, P.PartyName, C.SalePrice, C.Qty, C.freeQty, P.Status,P.Company_ID,P.DeleteData from tbl_PurchaseBill as P , tbl_PurchaseBillInner as C   where P.ID = C.ID and  ItemName = '{0}' and P.Company_ID='" + NewCompany.company_id + "' and P.DeleteData='1')Union all(select P.TableName, P.PartyName, C.SalePrice, C.Qty, C.freeQty, P.Status,P.Company_ID,P.DeleteData from tbl_PurchaseOrder as P ,tbl_PurchaseOrderInner as C  where P.ID = C.ID and ItemName = '{0}' and P.Company_ID='" + NewCompany.company_id + "' and P.DeleteData='1')union all(select P.TableName, P.PartyName, C.SalePrice, C.Qty, C.freeQty, P.Status,P.Company_ID,P.DeleteData from tblQuotation as P , tbl_QuotationInner as C where P.ID = C.ID and ItemName = '{0}' and P.Company_ID='" + NewCompany.company_id + "' and P.DeleteData='1' )Union all(select P.TableName, P.PartyName, C.SalePrice, C.Qty, C.freeQty, P.Status,P.Company_ID,P.DeleteData from tbl_SaleInvoice as P , tbl_SaleInvoiceInner as C   where P.ID = C.ID and ItemName = '{0}' and P.Company_ID='" + NewCompany.company_id + "' and P.DeleteData='1' )union all (select P.TableName, P.PartyName, C.SalePrice, C.Qty, C.freeQty, P.Status,P.Company_ID,P.DeleteData from tbl_SaleOrder as P , tbl_SaleOrderInner as C  where P.ID = C.ID and ItemName = '{0}' and P.Company_ID='" + NewCompany.company_id + "' and P.DeleteData='1' )", lblItemName.Text);
                DataSet ds = new DataSet();
                SqlDataAdapter da = new SqlDataAdapter(Query, con);
                da.Fill(ds, "temp");
