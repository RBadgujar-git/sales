...
{ 
    public partial class ItemHomepage : UserControl
    {
        ...
        private void guna2TextBox2_TextChanged(object sender, EventArgs e)
        {
            try
            {
                string Query = string.Format("(select P.TableName,P.PartyName,C.SalePrice,C.Qty,C.freeQty,P.Status from tbl_CreditNote1 as P, tbl_CreditNoteInner as C  where P.TableName like '%{0}%' and ItemName='" + lblItemName.Text + "' and P.Company_ID='" + NewCompany.company_id + "' and P.DeleteData='1')union all(select P.TableName, P.PartyName, C.SalePrice, C.Qty, C.freeQty, P.Status from tbl_DebitNote as P , tbl_DebitNoteInner as C  where P.TableName like '%{0}%' and ItemName='" + lblItemName.Text + "' and P.Company_ID='" + NewCompany.company_id + "' and P.DeleteData='1')Union all(select P.TableName, P.PartyName, C.SalePrice, C.Qty, C.freeQty, P.Status from tbl_DeliveryChallan as P , tbl_DeliveryChallanInner as C where P.TableName like '%{0}%' and ItemName='" + lblItemName.Text + "' and P.Company_ID='" + NewCompany.company_id + "' and P.DeleteData='1')union all(select P.TableName, P.PartyName, C.SalePrice, C.Qty, C.freeQty, P.Status from tbl_PurchaseBill as P , tbl_PurchaseBillInner as C where P.TableName like '%{0}%' and ItemName='" + lblItemName.Text + "' and P.Company_ID='" + NewCompany.company_id + "' and P.DeleteData='1')Union all(select P.TableName, P.PartyName, C.SalePrice, C.Qty, C.freeQty, P.Status from tbl_PurchaseOrder as P ,tbl_PurchaseOrderInner as C  where P.TableName like '%{0}%' and ItemName='" + lblItemName.Text + "' and P.Company_ID='" + NewCompany.company_id + "' and P.DeleteData='1')union all(select P.TableName, P.PartyName, C.SalePrice, C.Qty, C.freeQty, P.Status from tblQuotation as P , tbl_QuotationInner as C where P.TableName like '%{0}%' and ItemName='" + lblItemName.Text + "' and P.Company_ID='" + NewCompany.company_id + "' and P.DeleteData='1' )Union all(select P.TableName, P.PartyName, C.SalePrice, C.Qty, C.freeQty, P.Status from tbl_SaleInvoice as P , tbl_SaleInvoiceInner as C   where P.TableName like '%{0}%' and ItemName='" + lblItemName.Text + "' and P.Company_ID='" + NewCompany.company_id + "' and P.DeleteData='1' )union all (select P.TableName, P.PartyName, C.SalePrice, C.Qty, C.freeQty, P.Status from tbl_SaleOrder as P , tbl_SaleOrderInner as C  where P.TableName like '%{0}%' and ItemName='" + lblItemName.Text + "' and P.Company_ID='" + NewCompany.company_id + "' and P.DeleteData='1' )", guna2TextBox2.Text);
                DataSet ds = new DataSet();
                SqlDataAdapter da = new SqlDataAdapter(Query, con);
                da.Fill(ds, "temp");
