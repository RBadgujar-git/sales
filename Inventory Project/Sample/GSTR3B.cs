        ...
        private void btnPrint_Click(object sender, EventArgs e)
        {
            ...
            if (MessageBox.Show("DO YOU WANT PRINT??", "PRINT", MessageBoxButtons.YesNo) == DialogResult.Yes)
            {
                ...
                try
                {
                    ...
                    string Query = string.Format("select a.CompanyName,a.PhoneNo,a.Address,a.EmailID,a.GSTNumber,a.AddLogo,b.PartyName,b.TotalCgst,b.TotalSgst,b.TotalIgst,b.CalTotal,b.Total from tbl_companymaster as a,tbl_saleinvoice as b where a.CompanyID='" + NewCompany.company_id + "' and b.Company_ID='" + NewCompany.company_id+"' and b.DeleteData='1'");
                    SqlDataAdapter SDA = new SqlDataAdapter(Query, con);
                    SDA.Fill(ds);

                    StiReport report = new StiReport();
                    report.Load(@"GSTR3BData.mrt");

                    report.Compile();
                    StiPage page = report.Pages[0];
                    report.RegData("GSTR3BData", "GSTR3BData", ds.Tables[0]);
