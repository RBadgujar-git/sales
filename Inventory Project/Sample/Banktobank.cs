    ...
    public partial class Banktobank : UserControl
    {
       ...
       public void DisplayLowQuantityItems()
        ...
        private void guna2TextBox1_TextChanged(object sender, EventArgs e)
        {
            ...
            {
                string Query = string.Format("select ID,FromBank,ToBank,Amount,	Date,Descripition from tbl_BanktoBankTransfer where Company_ID='" + NewCompany.company_id + "'  and DeleteData='1' and FromBank like '%{0}%'", textBox2.Text);
                DataSet ds = new DataSet();
